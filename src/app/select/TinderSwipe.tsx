...
const TinderSwipe: React.FC<Props> = memo(({ index, images, title, postCode, address, setCardList, setFlag }) => {
      ...
      <section className="main-card">
        <Link href="/select/[detail]" as={`/select/${index}`}>
          ...
          <section className="main-description">
            ...
            <h3 className="main-description-location"><PiMapPinLight className="main-icon" />所在地</h3>
